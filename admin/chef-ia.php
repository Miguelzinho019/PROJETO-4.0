...
$pageInfo = array(
    'title' => 'Meu Chef IA',
    'description' => 'Gere receitas com os leitura que você tem em casa utilizando a inteligência artificial.',
    'pageName' => 'chef-ia',
);
                        ...
                        <div class="card-body">
                            <form id="form">
                                <div class="form-group">
                                    ...
                                    <textarea name="leitura" id="leitura" cols="30" rows="10"
                                        class="form-control" placeholder="Digite os leitura da receita"></textarea>
                                </div>
                                <div class="form-group">
