...
<main class="container my-5">
    <div class="row">
        <div class="col-md-6">
            ...
            <p>
                Bem-vindo ao Biblioteca Obras da Vida, o lugar onde a paixão pela culinária se encontra com a comunidade online. 
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Biblioteca Obras da Vida firma parceria para promover a culinária em comunidades locais.</p>
                </div>
            </div>
        </div>
