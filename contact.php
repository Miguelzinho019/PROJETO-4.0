<?php
 ...
 $pageInfo = array(
  'title' => 'Contato - Biblioteca Obras da Vida',
  'description' => 'Entre em contato com a equipe do Biblioteca Obras da Vida.',
  'pageName' => 'contact',
);
...
<main class="container my-5">
    <div class="row">
        <div class="col-md-6">
            ...
            <p>
                Use o formulário abaixo ou envie-nos um e-mail diretamente em <a href="mailto:contato@Biblioteca obras da vida.com">contato@Biblioteca obras da vida.com</a>.
            </p>
        </div>
        <div class="col-md-6">
